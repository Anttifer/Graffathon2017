...
private:
	...
	// The macro CREATE_TRACKING_MEMBER(TYPE, NAME) defines the following functions:
	...
	CREATE_TRACKING_MEMBER(Eigen::Vector3f, clear_color)
	CREATE_TRACKING_MEMBER(Eigen::Vector2f, screen_center)
	CREATE_TRACKING_MEMBER(double, pixels_per_unit)
	CREATE_TRACKING_MEMBER(bool, frame_visible)
	CREATE_TRACKING_MEMBER(bool, result_visible)
	CREATE_TRACKING_MEMBER(bool, menu_bar_visible)
	CREATE_TRACKING_MEMBER(bool, settings_window_visible)
	CREATE_TRACKING_MEMBER(bool, usage_window_visible)
	CREATE_TRACKING_MEMBER(bool, object_settings_visible)
	CREATE_TRACKING_MEMBER(bool, view_settings_visible)
	CREATE_TRACKING_MEMBER(bool, export_settings_visible)
	CREATE_TRACKING_MEMBER(int, export_width)
	CREATE_TRACKING_MEMBER(int, export_height)

	CREATE_TRACKING_MEMBER(Eigen::Vector4f, position_4d)
	CREATE_TRACKING_MEMBER(Eigen::Vector3f, position_3d)
	CREATE_TRACKING_MEMBER(float, fov_4d)
